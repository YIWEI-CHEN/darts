...
ETA=0.6
GPU=3
EXP_PATH="exp/MyDARTS/rank_loss_seed${SEED}/F2_unif${ETA}_${DATA}_${LOSS}${ALPHA}_${ARCH}_clean_train_gpu${GPU}"
...
#ETA=0.6
#GPU=2
#EXP_PATH="exp/MyDARTS/rank_loss_seed${SEED}/F2_unif${ETA}_${DATA}_${LOSS}_${ARCH}_clean_train_gpu${GPU}"
#
#python rank_loss.py --data "/home/yiwei/${DATA}" --batch_size 64 --gpu ${GPU} \
#    --epochs ${EPOCHS} --save ${EXP_PATH} --seed ${SEED} --auxiliary --cutout \
#    --corruption_prob ${ETA} --corruption_type unif --loss_func ${LOSS} \
#    --arch ${ARCH} --train_portion 0.9 --layers ${LAYERS} --clean_train
...
#ETA=0.6
#GPU=1
#EXP_PATH="exp/MyDARTS/rank_loss_seed${SEED}/F3_unif${ETA}_${DATA}_${LOSS}_${ARCH}_clean_train_gpu${GPU}"
#
#python rank_loss.py --data "/home/yiwei/${DATA}" --batch_size 64 --gpu ${GPU} \
#    --epochs ${EPOCHS} --save ${EXP_PATH} --seed ${SEED} --auxiliary --cutout \
#    --corruption_prob ${ETA} --corruption_type unif --loss_func ${LOSS} \
